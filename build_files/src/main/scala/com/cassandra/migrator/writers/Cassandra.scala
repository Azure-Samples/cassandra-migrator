package com.cassandra.migrator.writers

import com.datastax.spark.connector.writer._
import com.datastax.spark.connector._
import com.cassandra.migrator.Connectors
import com.cassandra.migrator.config.{ CopyType, Rename, TargetSettings }
import com.cassandra.migrator.readers.TimestampColumns
import org.apache.log4j.LogManager
import org.apache.spark.sql.{ DataFrame, Row, SparkSession }

object Cassandra {
  val log = LogManager.getLogger("com.cassandra.migrator.writer.Cassandra")

  def writeDataframe(
    target: TargetSettings.Cassandra,
    renames: List[Rename],
    df: DataFrame,
